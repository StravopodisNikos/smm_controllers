#include "smm_controllers/cartesian_space/cartesian_id_controller.hpp"
...
CartesianInvDynController::CartesianInvDynController()
: controller_interface::ControllerInterface()
{
}

controller_interface::CallbackReturn CartesianInvDynController::on_init()
{
  try {
...
CartesianInvDynController::command_interface_configuration() const
{
...
controller_interface::InterfaceConfiguration
CartesianInvDynController::state_interface_configuration() const
{
  controller_interface::InterfaceConfiguration config;
  config.type = controller_interface::interface_configuration_type::INDIVIDUAL;
...
controller_interface::CallbackReturn CartesianInvDynController::on_configure(
  const rclcpp_lifecycle::State &)
{
    ...
    desired_cartesian_sub_ =
        ...
        std::bind(
            &CartesianInvDynController::desiredCartesianCallback,
            this,
            std::placeholders::_1));
    ...
    RCLCPP_INFO(
        get_node()->get_logger(),
        "Configured CartesianInvDynController with %zu joints.", n);
...
controller_interface::CallbackReturn CartesianInvDynController::on_activate(
  const rclcpp_lifecycle::State &)
{
  const auto n = joint_names_.size();
  ...
  if (hold_initial_position_ || x_des_.empty()) {
    ...
    RCLCPP_INFO(
      get_node()->get_logger(),
      "CartesianInvDynController holding initial TCP pose.");
  }

  return controller_interface::CallbackReturn::SUCCESS;
}

controller_interface::return_type CartesianInvDynController::update(
  const rclcpp::Time &,
...
void CartesianInvDynController::desiredCartesianCallback(
...
bool CartesianInvDynController::acceptDesiredCartesianState(
...
bool CartesianInvDynController::readStateInterfaces()
{
  const auto n = joint_names_.size();
...
bool CartesianInvDynController::computeCartesianPoseKinematics()
{
...
bool CartesianInvDynController::computeSquareJacobianConditioning()
{
  if (
    Jx_.rows() == 0 ||
    Jx_.cols() == 0 ||
...
bool CartesianInvDynController::computeCartesianInvDynCommand()
{
  const auto n = joint_names_.size();
...
void CartesianInvDynController::computeJacobianConditioning()
{
  jacobian_condition_ = 0.0;
  singular_values_.setZero();
...
void CartesianInvDynController::computeJacobianColumnNorms()
{
  jacobian_column_norms_.setZero();
...
void CartesianInvDynController::publishDesiredCartesianState()
{
...
void CartesianInvDynController::publishCurrentCartesianState()
{
...
void CartesianInvDynController::publishCartesianErrorState()
{
  if (!publish_error_state_) {
    return;
  }
...
void CartesianInvDynController::publishDebugState()
{
  if (!publish_error_state_) {
    return;
  }
...
void CartesianInvDynController::publishFullDebugState()
{
  if (!publish_full_debug_state_) {
    return;
  }
...
bool CartesianInvDynController::writeCommandInterfaces()
{
...
bool CartesianInvDynController::expandVector3(
  ...
  const std::string & field_name)
{
  ...
  if (input.size() != 3) {
    std::cerr << "[CartesianInvDynController] Parameter '"
              << field_name
...
bool CartesianInvDynController::quaternionVectorToRotation(
  const std::vector<double> & input,
...
Eigen::Quaterniond CartesianInvDynController::rotationToQuaternion(
...
Eigen::Vector3d CartesianInvDynController::computeOrientationError(
...
void CartesianInvDynController::fillPoseStamped(
...
PLUGINLIB_EXPORT_CLASS(
  smm_controllers::CartesianInvDynController,
  controller_interface::ControllerInterface)