...
class CartesianPosePDGravityController : public controller_interface::ControllerInterface
{
public:
  CartesianPosePDGravityController();
...
private:
  ...
  bool computeCartesianPosePDGravityCommand();
